                ...
                <div className="flex flex-col items-center text-center">
                  ...
                  <div className="flex flex-col w-full gap-3">
                    <button
                      ...
                      className={`w-full py-4 rounded-2xl text-[10px] font-bold uppercase tracking-[0.2em] text-white shadow-xl transition-all active:scale-95 ${getButtonColor(alert.type)}`}
                    >
                    ...
                    {(alert.showCancel || alert.onCancel) && (
                      <button
                        ...
                        className="w-full py-4 rounded-2xl text-[10px] font-bold uppercase tracking-[0.2em] text-gray-400 hover:bg-gray-50 transition-all active:scale-95 underline underline-offset-4"
                      >
