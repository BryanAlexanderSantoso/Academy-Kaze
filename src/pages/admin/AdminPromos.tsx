  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center h-screen bg-white">
        ...
        <p className="mt-6 text-gray-400 font-bold uppercase tracking-[0.3em] text-[10px] animate-pulse">Loading Promo Engine...</p>
      </div>
    );
  }
      ...
      <header className="bg-white border-b border-gray-100 sticky top-0 z-50 shadow-sm">
        <div className="max-w-[1600px] mx-auto px-6 md:px-10 py-7 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="flex items-center gap-6">
            ...
            <div>
              <h1 className="text-2xl font-bold tracking-tighter text-gray-900 uppercase ">Promo Management</h1>
              <div className="flex items-center gap-2 mt-0.5">
                <span className="flex h-1.5 w-1.5 rounded-full bg-green-500 animate-pulse"></span>
                <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest leading-none">Discount Engine Active</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            <div className="relative group">
              ...
              <input
                ...
                className="bg-gray-100 border-none rounded-2xl py-3.5 pl-12 pr-6 text-[10px] font-bold uppercase tracking-widest focus:ring-[12px] focus:ring-purple-500/5 focus:bg-white transition-all w-full md:w-80 shadow-inner placeholder:text-gray-400"
                value={searchTerm}
            ...
            <button
              ...
              className="flex items-center gap-2 px-6 py-3.5 bg-gradient-to-r from-purple-600 to-pink-500 text-white text-[10px] font-bold uppercase tracking-widest rounded-2xl shadow-xl shadow-purple-500/20 hover:shadow-2xl hover:shadow-purple-500/30 transition-all hover:scale-105 active:scale-95"
            >
          ...
          {[
            ...
            >
              ...
              <div className="flex items-end gap-3 mb-2">
                <span className="text-4xl font-bold tracking-tighter text-gray-900">{stat.value}</span>
              </div>
        ...
        <div className="bg-white rounded-[50px] shadow-sm border border-gray-100 overflow-hidden">
          <div className="px-8 md:px-10 py-8 border-b border-gray-50 bg-gray-50/30">
            <div className="flex items-center gap-3">
              ...
              <span className="text-[10px] font-bold text-gray-900 uppercase tracking-widest">Promo Code Registry</span>
            </div>
          </div>
          ...
          {filteredPromos.length > 0 ? (
                ...
                >
                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                    <div className="flex items-center gap-6 flex-1 min-w-0">
                      <div className={`w-16 h-16 rounded-[22px] flex items-center justify-center text-white font-bold text-2xl shadow-lg ${promo.is_active ? 'bg-gradient-to-br from-purple-500 to-pink-500 shadow-purple-500/20' : 'bg-gray-300'}`}>
                        <Percent className="w-7 h-7" />
                      </div>
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-3 mb-1">
                          <span className="text-lg font-bold text-gray-900 tracking-tight uppercase group-hover:text-purple-600 transition-colors">
                            {promo.code}
                          </span>
                          <button
                          ...
                          <span className={`px-3 py-1 rounded-full text-[9px] font-bold uppercase tracking-wider ${promo.is_active ? 'bg-emerald-50 text-emerald-600 border border-emerald-100' : 'bg-gray-100 text-gray-400 border border-gray-200'}`}>
                    ...
                    <div className="flex items-center gap-8">
                      <div className="text-center">
                        <p className="text-3xl font-bold text-purple-600 tracking-tighter">{promo.discount_percent}%</p>
                        <p className="text-[9px] font-bold text-gray-400 uppercase tracking-widest">Diskon</p>
                      </div>
                      <div className="text-center">
                        <p className="text-lg font-bold text-gray-700">{promo.current_usage}{promo.max_usage ? `/${promo.max_usage}` : '/∞'}</p>
                        <p className="text-[9px] font-bold text-gray-400 uppercase tracking-widest">Usage</p>
                      </div>
                      <div className="text-center min-w-[80px]">
                        {promo.valid_until ? (
                          <>
                            ...
                            <p className="text-[9px] font-bold text-gray-400 uppercase tracking-widest">Expires</p>
                          </>
                        ) : (
                          <>
                            <p className="text-xs font-bold text-emerald-600">♾️ Forever</p>
                            <p className="text-[9px] font-bold text-gray-400 uppercase tracking-widest">No Expiry</p>
                          </>
                        )}
                      </div>
                        ...
                        {deleteConfirm === promo.id ? (
                          <div className="flex items-center gap-1">
                            <button
                              ...
                              className="px-3 py-1.5 bg-red-500 text-white text-[9px] font-bold rounded-lg uppercase tracking-wider"
                            >
                              YA
                            </button>
                            <button
                              onClick={() => setDeleteConfirm(null)}
                              className="px-3 py-1.5 bg-gray-200 text-gray-600 text-[9px] font-bold rounded-lg uppercase tracking-wider"
                            >
                              BATAL
                            </button>
                          </div>
            ...
            <div className="py-32 text-center">
              ...
              >
                ...
                <h3 className="text-2xl font-bold text-gray-900 uppercase ">No Promos Found</h3>
                ...
                {!searchTerm && (
                  <button
                    onClick={openCreateForm}
                    className="mt-8 flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-purple-600 to-pink-500 text-white text-[10px] font-bold uppercase tracking-widest rounded-2xl shadow-xl shadow-purple-500/20 hover:scale-105 transition-all"
                  >
                    <Plus className="w-4 h-4" />
                    CREATE FIRST PROMO
                  </button>
            ...
            >
              <div className="flex items-center justify-between mb-10">
                <div className="flex items-center gap-4">
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 tracking-tighter uppercase ">
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                <div className="space-y-3">
                  <label className="text-[10px] font-bold text-gray-400 uppercase tracking-widest ml-2">Kode Promo</label>
                  <input
                    type="text"
                    value={formData.code}
                    onChange={e => setFormData({ ...formData, code: e.target.value.toUpperCase() })}
                    className="w-full bg-gray-50 border-none rounded-2xl p-5 text-lg font-bold text-gray-900 uppercase tracking-widest focus:ring-4 focus:ring-purple-500/10 focus:bg-white transition-all shadow-inner placeholder:text-gray-300"
                ...
                <div className="space-y-3">
                  <label className="text-[10px] font-bold text-gray-400 uppercase tracking-widest ml-2">Diskon (%)</label>
                  <div className="relative">
                    <input
                      type="number"
                      ...
                      min={1}
                      max={100}
                      className="w-full bg-gray-50 border-none rounded-2xl p-5 text-3xl font-bold text-purple-600 tracking-tighter focus:ring-4 focus:ring-purple-500/10 focus:bg-white transition-all shadow-inner"
                      required
                    />
                  ...
                  <div className="flex gap-2 mt-2">
                    {[10, 20, 25, 50, 75].map(v => (
                      <button
                        ...
                        className={`px-4 py-2 rounded-xl text-[10px] font-bold uppercase tracking-wider transition-all ${formData.discount_percent === v ? 'bg-purple-600 text-white shadow-lg shadow-purple-500/20' : 'bg-gray-100 text-gray-500 hover:bg-purple-50 hover:text-purple-600'}`}
                      >
                        {v}%
                      </button>
                    ))}
                ...
                <div className="space-y-3">
                  <label className="text-[10px] font-bold text-gray-400 uppercase tracking-widest ml-2">Deskripsi (opsional)</label>
                  <input
                    type="text"
                ...
                <div className="flex items-center gap-4 p-5 bg-gray-50 rounded-2xl">
                  ...
                  <div>
                    <p className="text-sm font-bold text-gray-900">{formData.is_active ? 'Active' : 'Inactive'}</p>
                ...
                <button
                  type="submit"
                  className="w-full py-5 bg-gradient-to-r from-purple-600 to-pink-500 text-white font-bold uppercase tracking-widest text-sm rounded-[30px] shadow-2xl shadow-purple-500/30 hover:-translate-y-1 active:scale-95 transition-all"
                >
