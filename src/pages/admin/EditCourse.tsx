  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-white flex flex-col items-center justify-center">
        ...
        <p className="mt-6 text-gray-400 font-bold uppercase tracking-[0.3em] text-[10px] animate-pulse">Menyinkronkan Data Manifest...</p>
      </div>
    );
  }
            ...
            <div className="flex items-center gap-6">
              ...
              <div>
                ...
                <div className="flex items-center gap-2 mt-0.5">
                  ...
                  <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">{formData.title || 'Memuat Node...'}</p>
                </div>
              </div>
            </div>
      ...
      <main className="max-w-5xl mx-auto px-8 py-20">
        <form onSubmit={handleSubmit} className="space-y-16">
          <div className="text-center space-y-4 mb-24">
            ...
            <h2 className="text-6xl font-bold tracking-tighter uppercase text-gray-900">Tambal Node Pengetahuan</h2>
            ...
            <div className="bg-white border border-gray-100 rounded-[60px] p-16 relative overflow-hidden group shadow-sm hover:shadow-2xl transition-all duration-700">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                <div className="space-y-4 md:col-span-2">
                  <label className="text-[10px] font-bold text-gray-300 uppercase tracking-widest ml-1">Identifikasi Manifest (Judul)</label>
                  <input
                    type="text"
                ...
                <div className="space-y-4 md:col-span-2">
                  <label className="text-[10px] font-bold text-gray-300 uppercase tracking-widest ml-1">Abstrak Teknis (Deskripsi)</label>
                  <textarea
                ...
                <div className="space-y-4">
                  <label className="text-[10px] font-bold text-gray-300 uppercase tracking-widest ml-1">Jalur Kurikulum</label>
                  <div className="relative">
                    <select
                ...
                <div className="space-y-4">
                  <label className="text-[10px] font-bold text-gray-300 uppercase tracking-widest ml-1">Durasi Siklus (Jam)</label>
                  <div className="relative">
                    <input
                      type="number"
                ...
                <div className="space-y-4">
                  <label className="text-[10px] font-bold text-gray-300 uppercase tracking-widest ml-1">Timestamp Revisi</label>
                  <div className="relative">
                    <input
                      type="datetime-local"
                ...
                <div className="space-y-4">
                  <label className="text-[10px] font-bold text-gray-300 uppercase tracking-widest ml-1">Cetak Biru Visual (URL Thumbnail)</label>
                  <div className="relative">
                    <input
                      type="url"
            ...
            <div className="bg-white border border-gray-100 rounded-[60px] p-16 relative overflow-hidden group shadow-sm hover:shadow-2xl transition-all duration-700">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center gap-4 px-8 py-5 bg-indigo-50 rounded-3xl border border-indigo-100/50">
                  ...
                  <p className="text-[10px] font-bold text-indigo-600 uppercase tracking-widest">Hidrasi Aktif: Payload manifest siap sinkronisasi.</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row items-center justify-between p-16 bg-white border border-gray-100 rounded-[60px] shadow-sm">
              <div className="flex flex-col gap-12 w-full">
                ...
                <div className="flex items-start gap-8">
                  ...
                  <div>
                    <label htmlFor="is_published" className="text-2xl font-bold tracking-tighter cursor-pointer uppercase text-gray-900">Siaran Universal (Published)</label>
                    <p className="text-gray-400 text-[10px] font-bold uppercase tracking-widest mt-1">Jika aktif, manifest dapat diakses segera oleh semua operatif.</p>
                  </div>
                </div>
              </div>
