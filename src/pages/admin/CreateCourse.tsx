        ...
        <div className="max-w-7xl mx-auto px-8 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-6">
              ...
              <div>
                <h1 className="text-2xl font-bold tracking-tighter flex items-center gap-3 uppercase ">
                  <Zap className="w-6 h-6 text-indigo-600" />
                  Pembuatan Modul
                </h1>
                <div className="flex items-center gap-2 mt-0.5">
                  <span className="flex h-1.5 w-1.5 rounded-full bg-indigo-500 animate-pulse"></span>
                  <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Node Kurikulum Baru</p>
                </div>
              </div>
            </div>
      ...
      <main className="max-w-5xl mx-auto px-8 py-20">
        <form onSubmit={handleSubmit} className="space-y-16">
          <div className="text-center space-y-4 mb-24">
            ...
            <h2 className="text-6xl font-bold tracking-tighter uppercase text-gray-900">Inisiasi Modul</h2>
            <p className="text-gray-400 font-bold max-w-xl mx-auto uppercase tracking-[0.3em] text-[10px]">Inisialisasi urutan pendidikan baru ke dalam repositori global</p>
          </div>
          ...
          <div className="space-y-16">
            ...
            <div className="bg-white border border-gray-100 rounded-[60px] p-16 relative overflow-hidden group shadow-sm hover:shadow-2xl transition-all duration-700">
              ...
              <h3 className="text-2xl font-bold tracking-tight mb-12 flex items-center gap-5 uppercase text-gray-900">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                <div className="space-y-4 md:col-span-2">
                  <label className="text-[10px] font-bold text-gray-300 uppercase tracking-widest ml-1">Nama Aset (Judul)</label>
                  <input
                    type="text"
                    value={formData.title}
                    onChange={(e) => setFormData({ ...formData, title: e.target.value })}
                    className="w-full bg-gray-50 border-none rounded-[32px] py-6 px-10 text-gray-900 font-bold text-3xl tracking-tighter focus:ring-[12px] focus:ring-indigo-500/5 focus:bg-white transition-all shadow-inner placeholder:text-gray-200"
                ...
                <div className="space-y-4 md:col-span-2">
                  <label className="text-[10px] font-bold text-gray-300 uppercase tracking-widest ml-1">Abstrak Pengetahuan (Deskripsi)</label>
                  <textarea
                ...
                <div className="space-y-4">
                  <label className="text-[10px] font-bold text-gray-300 uppercase tracking-widest ml-1">Bidang Vektor (Jalur Belajar)</label>
                  <div className="relative">
                    <select
                      value={formData.category}
                      onChange={(e) => setFormData({ ...formData, category: e.target.value as 'fe' | 'be' | 'fs' })}
                      className="w-full bg-gray-50 border-none rounded-[30px] py-6 px-10 text-gray-900 font-bold text-xs uppercase tracking-[0.2em] focus:ring-[12px] focus:ring-indigo-500/5 focus:bg-white transition-all appearance-none cursor-pointer shadow-inner"
                      required
                    >
                ...
                <div className="space-y-4">
                  <label className="text-[10px] font-bold text-gray-300 uppercase tracking-widest ml-1">Konsumsi Waktu (Jam)</label>
                  <div className="relative">
                    <input
                      type="number"
                      value={formData.duration_hours}
                      onChange={(e) => setFormData({ ...formData, duration_hours: e.target.value })}
                      className="w-full bg-gray-50 border-none rounded-[30px] py-6 px-10 text-gray-900 font-bold text-sm uppercase tracking-[0.25em] focus:ring-[12px] focus:ring-indigo-500/5 focus:bg-white transition-all shadow-inner"
                      placeholder="000"
                      min="1"
                    />
                ...
                <div className="space-y-4">
                  <label className="text-[10px] font-bold text-gray-300 uppercase tracking-widest ml-1">Slot Deployment (Tanggal)</label>
                  <div className="relative">
                    <input
                      type="datetime-local"
                      value={formData.schedule_date}
                      onChange={(e) => setFormData({ ...formData, schedule_date: e.target.value })}
                      className="w-full bg-gray-50 border-none rounded-[30px] py-6 px-10 text-gray-900 font-bold text-[11px] uppercase tracking-[0.2em] focus:ring-[12px] focus:ring-indigo-500/5 focus:bg-white transition-all shadow-inner"
                    />
                ...
                <div className="space-y-4">
                  <label className="text-[10px] font-bold text-gray-300 uppercase tracking-widest ml-1">Penanda Visual (URL Thumbnail)</label>
                  <div className="relative">
                    <input
                      type="url"
                ...
                <div className="space-y-4">
                  <label className="text-[10px] font-bold text-gray-300 uppercase tracking-widest ml-1">Nama Penulis</label>
                  <input
                    type="text"
                    value={formData.author_name}
                    onChange={(e) => setFormData({ ...formData, author_name: e.target.value })}
                    className="w-full bg-gray-50 border-none rounded-[30px] py-6 px-10 text-gray-900 font-bold text-sm uppercase tracking-[0.2em] focus:ring-[12px] focus:ring-indigo-500/5 focus:bg-white transition-all shadow-inner"
                    placeholder="John Doe"
                  />
                </div>

                <div className="space-y-4">
                  <label className="text-[10px] font-bold text-gray-300 uppercase tracking-widest ml-1">URL Foto Penulis</label>
                  <div className="relative">
                    <input
                      type="url"
            ...
            <div className="bg-white border border-gray-100 rounded-[60px] p-16 relative overflow-hidden group shadow-sm hover:shadow-2xl transition-all duration-700">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center gap-4 px-8 py-5 bg-indigo-50 rounded-3xl border border-indigo-100/50">
                  ...
                  <p className="text-[10px] font-bold text-indigo-600 uppercase tracking-widest">Kompiler Siap: Dukungan untuk tag HTML standar aktif.</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row items-center justify-between p-16 bg-white border border-gray-100 rounded-[60px] shadow-sm">
              <div className="flex flex-col gap-12 w-full">
                <div className="flex items-start gap-8">
                  ...
                  <div>
                    <label htmlFor="is_free" className="text-2xl font-bold tracking-tighter cursor-pointer uppercase text-gray-900">Akses Gratis (Penuh)</label>
                    <p className="text-gray-400 text-[10px] font-bold uppercase tracking-widest mt-1">Jika aktif, member gratis dapat mengakses SELURUH modul di kursus ini tanpa premium.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-8">
                  ...
                  <div>
                    <label htmlFor="is_published" className="text-2xl font-bold tracking-tighter cursor-pointer uppercase text-gray-900">Siaran Global (Published)</label>
                    <p className="text-gray-400 text-[10px] font-bold uppercase tracking-widest mt-1">Buat modul ini dapat ditemukan segera setelah inisialisasi.</p>
                  </div>
                </div>
              </div>
              <div className="flex gap-6 w-full md:w-auto mt-10 md:mt-0">
                <button
                  type="button"
                  onClick={() => navigate('/admin/courses')}
                  className="flex-1 md:flex-none px-12 py-6 bg-gray-50 hover:bg-gray-100 text-gray-400 font-bold uppercase tracking-[0.25em] rounded-[30px] transition-all shadow-inner"
                >
                  Batal
                </button>
                <button
                  type="submit"
                  disabled={loading}
                  className="flex-1 md:flex-none px-16 py-6 bg-indigo-600 hover:bg-indigo-700 text-white font-bold uppercase tracking-[0.25em] rounded-[30px] shadow-2xl shadow-indigo-600/30 transition-all active:scale-95 disabled:opacity-50 flex items-center justify-center gap-4"
                >
