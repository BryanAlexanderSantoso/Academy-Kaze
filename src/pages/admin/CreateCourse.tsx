                        ...
                        <div className="flex items-center gap-6">
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-2 mt-0.5">
                                    ...
                                    <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest">Node Kurikulum Baru</p>
                                </div>
                            </div>
                        </div>
            ...
            <main className="max-w-5xl mx-auto px-8 py-20">
                <form onSubmit={handleSubmit} className="space-y-16">
                    <div className="text-center space-y-4 mb-24">
                        ...
                        <h2 className="text-6xl font-black tracking-tighter uppercase italic text-gray-900">Inisiasi Modul</h2>
                        ...
                        <div className="bg-white border border-gray-100 rounded-[60px] p-16 relative overflow-hidden group shadow-sm hover:shadow-2xl transition-all duration-700">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                                <div className="space-y-4 md:col-span-2">
                                    <label className="text-[10px] font-black text-gray-300 uppercase tracking-widest ml-1">Nama Aset (Judul)</label>
                                    <input
                                        type="text"
                                ...
                                <div className="space-y-4 md:col-span-2">
                                    <label className="text-[10px] font-black text-gray-300 uppercase tracking-widest ml-1">Abstrak Pengetahuan (Deskripsi)</label>
                                    <textarea
                                ...
                                <div className="space-y-4">
                                    <label className="text-[10px] font-black text-gray-300 uppercase tracking-widest ml-1">Bidang Vektor (Jalur Belajar)</label>
                                ...
                                <div className="space-y-4">
                                    <label className="text-[10px] font-black text-gray-300 uppercase tracking-widest ml-1">Konsumsi Waktu (Jam)</label>
                                    <div className="relative">
                                        <input
                                            type="number"
                                ...
                                <div className="space-y-4">
                                    <label className="text-[10px] font-black text-gray-300 uppercase tracking-widest ml-1">Slot Deployment (Tanggal)</label>
                                    <div className="relative">
                                        <input
                                            type="datetime-local"
                                ...
                                <div className="space-y-4">
                                    <label className="text-[10px] font-black text-gray-300 uppercase tracking-widest ml-1">Penanda Visual (URL Thumbnail)</label>
                                    <div className="relative">
                                        <input
                                            type="url"
                        ...
                        <div className="bg-white border border-gray-100 rounded-[60px] p-16 relative overflow-hidden group shadow-sm hover:shadow-2xl transition-all duration-700">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="flex items-center gap-4 px-8 py-5 bg-indigo-50 rounded-3xl border border-indigo-100/50">
                                    ...
                                    <p className="text-[10px] font-black text-indigo-600 uppercase tracking-widest">Kompiler Siap: Dukungan untuk tag HTML standar aktif.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col md:flex-row items-center justify-between p-16 bg-white border border-gray-100 rounded-[60px] shadow-sm">
                            <div className="flex flex-col gap-12 w-full">
                                ...
                                <div className="flex items-start gap-8">
                                    ...
                                    <div>
                                        <label htmlFor="is_published" className="text-2xl font-black tracking-tighter cursor-pointer uppercase italic text-gray-900">Siaran Global (Published)</label>
                                        <p className="text-gray-400 text-[10px] font-black uppercase tracking-widest mt-1">Buat modul ini dapat ditemukan segera setelah inisialisasi.</p>
                                    </div>
                                </div>
                            </div>
