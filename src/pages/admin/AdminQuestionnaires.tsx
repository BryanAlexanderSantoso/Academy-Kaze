  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center h-screen bg-gray-50">
        ...
        <p className="mt-4 text-gray-400 font-bold uppercase tracking-widest text-[10px] animate-pulse">Syncing Knowledge Base...</p>
      </div>
    );
  }
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="flex items-center gap-5">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 mt-0.5">
                ...
                <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Master Studio</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 p-1.5 bg-gray-100/50 rounded-2xl">
            <button
              ...
              className={`px-6 py-2.5 text-xs font-bold uppercase tracking-widest rounded-xl transition-all ${activeTab === 'manage'
            ...
            <button
              ...
              className={`px-6 py-2.5 text-xs font-bold uppercase tracking-widest rounded-xl transition-all ${activeTab === 'create'
                ? 'bg-white text-indigo-600 shadow-xl shadow-indigo-500/10 scale-105'
                : 'text-gray-400 hover:text-gray-600'
                }`}
            >
          ...
          <div className="space-y-8">
            ...
            {filteredQuestionnaires.length === 0 ? (
              <div className="card py-32 text-center border-dashed border-2 bg-gray-50/50">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-2 uppercase">No Data Found</h3>
                ...
                <button
                  onClick={() => setActiveTab('create')}
                  className="btn-primary py-4 px-10 rounded-2xl font-bold tracking-widest text-xs shadow-2xl shadow-indigo-600/30"
                >
                  OPEN FORGE STUDIO
                </button>
              </div>
                      ...
                      <div className="p-8 flex flex-col flex-1">
                        <div className="flex items-start justify-between mb-6">
                          <div className="flex gap-2">
                            <span className={`px-3 py-1 text-[8px] font-bold uppercase tracking-widest rounded-full ${q.is_published
                              ? 'bg-indigo-50 text-indigo-600'
                              : 'bg-gray-100 text-gray-400'
                              }`}>
                              {q.is_published ? 'Live' : 'Draft'}
                            </span>
                            <span className="px-3 py-1 text-[8px] font-bold uppercase tracking-widest rounded-full bg-gray-50 text-gray-400">
                              ID: {q.id.slice(0, 5)}
                            </span>
                          </div>
                        ...
                        <h3 className="text-xl font-bold text-gray-900 mb-2 leading-tight group-hover:text-indigo-600 transition-colors">{q.title}</h3>
                        <p className="text-xs text-gray-400 font-medium mb-8 line-clamp-2 leading-relaxed ">{q.description || 'No description provided.'}</p>
                        ...
                        <div className="mt-auto grid grid-cols-2 gap-3 pt-6 border-t border-gray-50">
                          <button
                            ...
                            className="flex items-center justify-center gap-2 py-3.5 rounded-xl bg-gray-900 text-white text-[10px] font-bold uppercase tracking-widest hover:bg-black transition-all shadow-lg shadow-gray-900/10 active:scale-95"
                          >
                          ...
                          <button
                            ...
                            className={`flex items-center justify-center gap-2 py-3.5 rounded-xl text-[10px] font-bold uppercase tracking-widest transition-all active:scale-95 border-2 ${q.is_published
            ...
            <div className="lg:col-span-3 space-y-8">
              ...
              >
                ...
                <div className="flex items-center gap-4 mb-8">
                  ...
                  <h2 className="text-2xl font-bold text-gray-900 tracking-tight">Project Identity</h2>
                </div>
                <div className="space-y-6 relative">
                  <div>
                    <label className="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-2 ml-1">Quiz Header</label>
                    <input
                      type="text"
                      value={title}
                      onChange={(e) => setTitle(e.target.value)}
                      className="w-full bg-gray-50 border-none focus:ring-0 focus:bg-white rounded-[24px] p-6 text-xl font-bold placeholder:text-gray-200 transition-all shadow-inner"
                      placeholder="Enter project title..."
                    />
                  </div>
                  <div>
                    <label className="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-2 ml-1">Brief Description</label>
                    <textarea
                      value={description}
              ...
              <div className="space-y-6">
                <div className="flex items-center justify-between px-2">
                  <h2 className="text-xl font-bold text-gray-900 tracking-tight flex items-center gap-3">
                    Assessment Matrix
                    <span className="bg-indigo-600 text-white text-[10px] font-bold px-2 py-0.5 rounded-full">{questions.length}</span>
                  </h2>
                  <div className="flex gap-2">
                    <button
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
                    {(['multiple_choice', 'checkbox', 'short_answer', 'long_answer', 'rating', 'linear_scale'] as QuestionType[]).map((type) => (
                      ...
                      >
                        ...
                        <span className="text-[10px] font-bold uppercase tracking-widest text-gray-400 group-hover:text-white transition-colors">{getQuestionTypeName(type)}</span>
                      </button>
                    ))}
                  </div>
                ) : (
                  <div className="space-y-6">
                              ...
                              <div className="flex items-start gap-6">
                                ...
                                <div className="flex-1">
                                  <div className="flex items-center gap-3 mb-6">
                                    ...
                                    <span className="text-[10px] font-bold uppercase tracking-widest text-gray-400">Question #{index + 1} — {getQuestionTypeName(question.type)}</span>
                                  </div>
                                  ...
                                  <div className="space-y-4">
                                    <input
                                      ...
                                      className="w-full bg-gray-50/50 border-none rounded-2xl p-5 text-lg font-bold focus:bg-white transition-all shadow-inner placeholder:text-gray-200"
                                    ...
                                    <input
                                      ...
                                      className="w-full bg-gray-50/50 border-none rounded-xl p-4 text-xs font-medium focus:bg-white transition-all shadow-inner placeholder:text-gray-200 "
                                    ...
                                    {(question.type === 'multiple_choice' || question.type === 'checkbox') && (
                                      <div className="mt-8 space-y-3 bg-gray-50/50 p-6 rounded-[32px] border border-gray-100 border-dashed">
                                        <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-4">Response Matrix</p>
                                        ...
                                        <button
                                          ...
                                          className="w-full py-4 rounded-xl border-2 border-dashed border-gray-200 text-[10px] font-bold text-gray-400 hover:text-indigo-600 hover:border-indigo-200 transition-all uppercase tracking-widest flex items-center justify-center gap-2 mt-2"
                                        >
                                    ...
                                    <div className="flex items-center justify-between pt-6 mt-6 border-t border-gray-50">
                                      <div className="flex items-center gap-8">
                                        <label className="flex items-center gap-3 cursor-pointer group/req">
                                          ...
                                          <span className="text-[10px] font-bold uppercase tracking-widest text-gray-400 group-hover/req:text-gray-900">Required</span>
                                        </label>
                                        <div className="flex items-center gap-3">
                                          <span className="text-[10px] font-bold uppercase tracking-widest text-gray-400">Score Payload:</span>
                                          <input
                                            type="number"
                                            value={question.points}
                                            onChange={(e) => updateQuestion(question.id, { points: parseInt(e.target.value) || 0 })}
                                            className="w-16 bg-gray-50 border-none rounded-lg p-2 text-center text-xs font-bold text-indigo-600"
                                            min="0"
                                          />
                                        </div>
                                      </div>
                    ...
                    <div className="pt-4">
                      <select
                        ...
                        className="w-full bg-indigo-600 text-white font-bold uppercase tracking-widest text-xs py-5 rounded-[24px] shadow-2xl shadow-indigo-600/30 hover:bg-indigo-700 transition-all outline-none appearance-none cursor-pointer text-center"
                        defaultValue=""
                      >
              ...
              >
                <div className="space-y-10">
                    ...
                    <div className="grid grid-cols-1 gap-2">
                      {(['fe', 'be', 'fs'] as const).map((path) => (
                        <button
                          ...
                          className={`px-4 py-4 rounded-2xl text-[10px] font-bold uppercase tracking-widest transition-all text-left flex items-center justify-between border-2 ${targetLearningPaths.includes(path)
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="space-y-4">
                      <div>
                        <label className="block text-[8px] font-bold text-gray-400 uppercase tracking-widest mb-2 ml-1">Deadline Sequence</label>
                        <input
                          type="datetime-local"
                          value={dueDate}
                          onChange={(e) => setDueDate(e.target.value)}
                          className="w-full bg-gray-50 border-none rounded-xl p-4 text-xs font-bold focus:bg-white transition-all outline-none"
                        />
                      </div>
                      <div className="grid grid-cols-2 gap-3">
                        <div>
                          <label className="block text-[8px] font-bold text-gray-400 uppercase tracking-widest mb-2 ml-1">Limit (min)</label>
                          <input
                            type="number"
                            value={timeLimitMinutes || ''}
                            onChange={(e) => setTimeLimitMinutes(e.target.value ? parseInt(e.target.value) : undefined)}
                            className="w-full bg-gray-50 border-none rounded-xl p-4 text-xs font-bold text-center"
                            placeholder="∞"
                          />
                        </div>
                        <div>
                          <label className="block text-[8px] font-bold text-gray-400 uppercase tracking-widest mb-2 ml-1">Attempts</label>
                          <input
                            type="number"
                            value={maxAttempts}
                  ...
                  <div className="space-y-4 pt-6">
                    <button
                      ...
                      className="w-full py-5 bg-indigo-600 text-white font-bold uppercase tracking-widest text-[10px] rounded-2xl shadow-xl shadow-indigo-600/30 hover:bg-indigo-700 transition-all flex items-center justify-center gap-3 hover:-translate-y-1 active:translate-y-0"
                    >
                    ...
                    <button
                      ...
                      className="w-full py-5 bg-white border-2 border-indigo-50 text-indigo-600 font-bold uppercase tracking-widest text-[10px] rounded-2xl hover:bg-indigo-50 transition-all flex items-center justify-center gap-3"
                    >
                    ...
                    <button
                      onClick={resetForm}
                      className="w-full py-3 text-[8px] font-bold uppercase tracking-widest text-gray-300 hover:text-red-500 transition-colors"
                    >
                      Purge Form Buffer
                    </button>
                  </div>
