      ...
      >
        ...
        <div className="hidden lg:flex flex-col justify-between p-16 bg-gray-50/50 relative overflow-hidden border-r border-gray-100">
          ...
          <div className="relative z-10 grid grid-cols-2 gap-6">
            <div className="p-8 bg-white rounded-[40px] shadow-sm border border-gray-100 group">
              ...
              <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Platform Version</p>
              <p className="text-xl font-bold text-gray-900 tracking-tighter uppercase ">V.4.2</p>
            </div>
            <div className="p-8 bg-white rounded-[40px] shadow-sm border border-gray-100 group">
              ...
              <p className="text-xl font-bold text-gray-900 tracking-tighter uppercase ">ONLINE</p>
            </div>
          </div>
        ...
        <div className="p-10 md:p-20 flex flex-col justify-center bg-white">
          <div className="mb-12">
            ...
            <h3 className="text-4xl font-bold text-gray-900 mb-2 tracking-tighter uppercase ">Member Login</h3>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center ml-4 mr-4">
                ...
                <Link to="/forgot-password" title="Recovery Protocol" className="text-[9px] font-bold text-indigo-600 uppercase tracking-widest hover:text-indigo-800 transition-colors">Recovery</Link>
          ...
          <div className="mt-12 text-center space-y-8">
            ...
            <div className="flex items-center justify-center gap-6 pt-10 border-t border-gray-50">
              <Link
                to="/admin"
                className="flex items-center gap-2 text-[9px] font-bold text-gray-300 hover:text-indigo-500 transition-all uppercase tracking-[0.3em]"
              >
