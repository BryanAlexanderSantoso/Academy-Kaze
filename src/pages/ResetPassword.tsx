      ...
      <div className="min-h-screen bg-white flex items-center justify-center p-6">
        <div className="w-full max-w-xl text-center space-y-8">
          ...
          <div className="space-y-2">
            <h4 className="text-2xl font-bold text-gray-900 tracking-tighter uppercase ">Session Expired</h4>
          ...
          <Link
            to="/forgot-password"
            className="inline-flex items-center justify-center gap-3 w-full bg-gray-900 text-white hover:bg-black transition-all py-6 rounded-[30px] text-[10px] font-bold uppercase tracking-[0.3em]"
          >
            Request_New_Uplink
          </Link>
        </div>
    ...
    <div className="min-h-screen bg-white flex items-center justify-center p-6 relative overflow-hidden font-sans selection:bg-indigo-100">
      ...
      >
        <div className="mb-12">
          ...
          <h3 className="text-4xl font-bold text-gray-900 mb-2 tracking-tighter uppercase ">New Security Key</h3>
        ...
        {!success ? (
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              <label className="text-[10px] font-bold text-gray-400 uppercase tracking-widest ml-4">New Security Cipher</label>
            ...
            <div className="space-y-2">
              <label className="text-[10px] font-bold text-gray-400 uppercase tracking-widest ml-4">Verify Security Cipher</label>
              <div className="relative group/input">
                <Lock className="absolute left-6 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-300 group-focus-within/input:text-indigo-600 transition-colors" />
                <input
                  type="password"
          ...
          >
            ...
            <div className="space-y-2">
              <h4 className="text-2xl font-bold text-gray-900 tracking-tighter uppercase ">Cipher Integrated</h4>
              <p className="text-gray-400 font-bold text-sm uppercase tracking-tight leading-relaxed">
