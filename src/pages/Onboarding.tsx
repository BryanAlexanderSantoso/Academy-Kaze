  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center p-6 relative overflow-hidden selection:bg-indigo-100">
              ...
              <div className="space-y-10 order-2 lg:order-1">
                <div className="space-y-6">
                  <motion.div
                    ...
                    className="inline-flex items-center gap-3 px-6 py-2 bg-indigo-50 border border-indigo-100 rounded-full text-indigo-600 text-[10px] font-bold uppercase tracking-[0.3em]"
                  >
                    <TutorialIcon className="w-4 h-4" />
                    {currentTutorial.tag}
                  </motion.div>
                  <div className="space-y-4">
                    <h2 className="text-[10px] font-bold uppercase tracking-[0.5em] text-gray-400">{currentTutorial.subtitle}</h2>
                    <h1 className="text-6xl md:text-8xl font-bold text-gray-900 tracking-tighter uppercase leading-[0.9]">
                ...
                <div className="flex flex-col sm:flex-row items-center gap-6 pt-8">
                  <button
                    ...
                    className="group relative bg-gray-900 text-white px-12 py-6 rounded-[30px] font-bold uppercase tracking-[0.2em] text-[10px] shadow-2xl shadow-gray-900/20 hover:bg-indigo-600 transition-all active:scale-95 flex items-center justify-center gap-4 w-full sm:w-auto"
                  >
            ...
            >
              <div className="mb-20">
                <motion.div
                  ...
                  className="inline-flex items-center gap-2 px-6 py-2 bg-indigo-50 border border-indigo-100 rounded-full text-indigo-600 text-[10px] font-bold uppercase tracking-[0.3em] mb-10"
                >
                  <Rocket className="w-4 h-4" />
                  Path Selection
                </motion.div>
                <h1 className="text-7xl md:text-9xl font-bold text-gray-900 mb-8 tracking-tighter uppercase leading-none">
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="relative z-10">
                        <h3 className="text-3xl font-bold text-gray-900 mb-4 tracking-tighter uppercase flex items-center gap-3 ">
                          {path.title}
              ...
              >
                <button
                  ...
                  className="group relative bg-gray-900 text-white px-16 py-8 rounded-full font-bold uppercase tracking-[0.3em] text-xs shadow-3xl shadow-gray-900/20 hover:bg-indigo-600 transition-all active:scale-95 disabled:opacity-20 disabled:cursor-not-allowed overflow-hidden"
                >
                ...
                <p className="text-[10px] font-bold text-gray-300 uppercase tracking-widest flex items-center gap-3">
      ...
      <div className="fixed top-1/2 right-10 -translate-y-1/2 hidden 2xl:block opacity-10">
        <p className="text-[10px] font-bold text-gray-900 uppercase tracking-[1em]" style={{ writingMode: 'vertical-rl' }}>KAZE_FOR_DEVELOPER</p>
      </div>
    </div>
  );
};
