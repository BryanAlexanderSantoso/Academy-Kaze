      ...
      <header className="sticky top-0 bg-white/90 backdrop-blur-lg border-b border-gray-100 z-50">
        <div className="max-w-6xl mx-auto px-6 md:px-8 h-20 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            />
            <span className="text-xl font-bold tracking-tighter text-gray-900 uppercase">Kaze Developer</span>
          </div>
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <Link
              to="/signup"
              className="px-8 py-3 bg-blue-600 text-white text-xs font-bold uppercase tracking-[0.2em] rounded-2xl hover:bg-blue-700 transition-all shadow-lg shadow-blue-600/20 active:scale-95"
            >
              Daftar Gratis
            </Link>
          </div>
      ...
      <section className="relative pt-20 pb-24 md:pt-32 md:pb-32 overflow-hidden bg-gradient-to-b from-blue-50/50 to-white">
        <div className="max-w-6xl mx-auto px-6 md:px-8">
          <div className="grid md:grid-cols-2 gap-20 items-center">
            ...
            >
              <div className="inline-flex items-center gap-2 px-5 py-2.5 bg-blue-100 text-blue-700 rounded-full text-[10px] font-bold uppercase tracking-[0.2em] mb-8">
                <Rocket className="w-4 h-4" />
                Inisialisasi Karir Developer
              </div>

              <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-8 leading-[1.1] tracking-tighter uppercase">
                Belajar Menjadi{' '}
              ...
              <div className="flex flex-col sm:flex-row gap-6 mb-12">
                <Link
                  to="/signup"
                  className="px-10 py-5 bg-blue-600 text-white rounded-2xl font-bold uppercase tracking-[0.2em] text-xs hover:bg-blue-700 transition-all shadow-2xl shadow-blue-600/40 flex items-center justify-center gap-3 active:scale-95"
                >
                  Mulai Belajar
                ...
                <Link
                  to="/admin"
                  className="px-10 py-5 bg-white border-2 border-gray-100 text-gray-400 hover:text-gray-900 rounded-2xl font-bold uppercase tracking-[0.2em] text-xs hover:border-gray-300 transition-all flex items-center justify-center gap-3 active:scale-95 shadow-sm"
                >
              ...
              <div className="flex items-center gap-8 flex-wrap text-[10px] font-bold uppercase tracking-[0.1em] text-gray-400">
              ...
              <div className="bg-white rounded-[48px] shadow-2xl shadow-blue-500/10 border border-gray-100 p-10 relative overflow-hidden group">
                ...
                <div className="relative space-y-8">
                  <div className="flex items-center gap-5">
                    <div className="w-16 h-16 bg-gradient-to-br from-blue-600 to-indigo-600 rounded-2xl flex items-center justify-center text-white font-bold text-xl shadow-xl shadow-blue-600/20">
                      KD
                    </div>
                    <div>
                      <div className="font-bold text-gray-900 uppercase tracking-tighter text-xl">Dasbor Member</div>
                      <div className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Selamat Datang Operatif</div>
                    </div>
                  </div>
                  ...
                  <div className="grid gap-6">
                    <div className="p-8 bg-gray-50 rounded-3xl border border-gray-100 shadow-inner">
                      <div className="flex items-center justify-between mb-4">
                        <span className="text-[10px] font-bold text-blue-600 uppercase tracking-[0.2em]">Kemajuan Kursus</span>
                    ...
                    <div className="grid grid-cols-3 gap-4">
                      <div className="p-6 bg-white rounded-3xl border border-gray-50 shadow-sm text-center">
                        <div className="text-2xl font-bold text-gray-900 mb-1 tracking-tighter">12</div>
                        <div className="text-[9px] font-bold text-gray-400 uppercase tracking-[0.2em]">Modul</div>
                      </div>
                      <div className="p-6 bg-white rounded-3xl border border-gray-50 shadow-sm text-center">
                        <div className="text-2xl font-bold text-gray-900 mb-1 tracking-tighter">24</div>
                        <div className="text-[9px] font-bold text-gray-400 uppercase tracking-[0.2em]">Tugas</div>
                      </div>
                      <div className="p-6 bg-white rounded-3xl border border-gray-50 shadow-sm text-center">
                        <div className="text-2xl font-bold text-gray-900 mb-1 tracking-tighter">96</div>
                        <div className="text-[9px] font-bold text-gray-400 uppercase tracking-[0.2em]">Skor</div>
                      </div>
                    </div>
                    ...
                    <div className="p-5 bg-indigo-50/50 rounded-2xl border border-indigo-100/50 flex items-center gap-5">
                      ...
                      <div className="flex-1">
                        <div className="font-bold text-gray-900 text-xs uppercase tracking-tight">Pola React Lanjutan</div>
      ...
      <section className="py-24 bg-white relative overflow-hidden">
        <div className="max-w-6xl mx-auto px-6 md:px-8">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16">
            <div>
              <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-indigo-50 text-indigo-600 rounded-full text-[9px] font-bold uppercase tracking-[0.2em] mb-4">
                <Zap className="w-4 h-4" />
                Katalog Manifest
              </div>
              <h2 className="text-4xl md:text-5xl font-bold text-gray-900 tracking-tighter uppercase underline decoration-indigo-200 decoration-8 underline-offset-[12px]">
            ...
            {courses.map((course) => (
              ...
              >
                ...
                <div className="flex items-center gap-4 mb-8">
                  ...
                  <div>
                    <span className="text-[10px] font-bold text-indigo-400 uppercase tracking-widest">{course.category === 'fe' ? 'Frontend' : course.category === 'be' ? 'Backend' : 'Fullstack'}</span>
                    <div className="flex items-center gap-2 mt-0.5">
                      <Clock className="w-3 h-3 text-gray-300" />
                      <span className="text-[9px] font-bold text-gray-400 uppercase tracking-tighter">{course.duration_hours || '0'} Jam Akses</span>
                    </div>
                  </div>
                </div>

                <h3 className="text-xl font-bold text-gray-900 uppercase tracking-tight mb-4 group-hover:text-indigo-600 transition-colors">
                  {course.title}
                </h3>
                ...
                <div className="flex items-center justify-between pt-6 border-t border-gray-50">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">{course.author_name || 'Kaze Admin'}</span>
                  </div>
                  <div className="px-4 py-2 bg-gray-50 text-gray-900 text-[10px] font-bold uppercase tracking-widest rounded-xl hover:bg-indigo-600 hover:text-white transition-colors">
                    Lihat Silabus
                  </div>
                </div>
              </motion.div>
            ...
            >
              <div className="p-8 border-b border-gray-100 flex items-center justify-between bg-white sticky top-0 z-10">
                <div>
                  <div className="flex items-center gap-3 mb-2">
                    <span className="px-3 py-1 bg-indigo-50 text-indigo-600 rounded-full text-[9px] font-bold uppercase tracking-widest">Syllabus Manifest</span>
                    <h2 className="text-2xl font-bold text-gray-900 uppercase tracking-tighter shrink-0">{selectedCourse.title}</h2>
                  </div>
                  <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Operatif harus Masuk untuk mengakses payload unit</p>
                </div>
                <button
                  onClick={() => setSelectedCourse(null)}
              ...
              <div className="flex-1 overflow-y-auto p-8 space-y-4 custom-scrollbar bg-gray-50/50">
                {loadingChapters ? (
                  <div className="py-20 flex flex-col items-center justify-center">
                    ...
                    <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Mendekripsi Struktur Modul...</p>
                  </div>
                ) : selectedChapters.length === 0 ? (
                  <div className="py-20 text-center">
                    <p className="text-gray-400 font-bold uppercase tracking-widest text-xs">Belum ada modul yang terdaftar dalam manifest ini.</p>
                  </div>
                ) : (
                    ...
                    {selectedChapters.map((chapter, index) => (
                      ...
                      >
                        <div className="flex items-center gap-6">
                          <div className="w-12 h-12 bg-gray-50 rounded-2xl flex items-center justify-center text-gray-400 font-bold text-sm group-hover:bg-indigo-50 group-hover:text-indigo-600 transition-colors">
                            {index + 1}
                          </div>
                          <div>
                            <h4 className="font-bold text-gray-900 uppercase tracking-tight mb-1 group-hover:text-indigo-600 transition-colors">{chapter.title}</h4>
                            <div className="flex items-center gap-3">
                              ...
                              <div className="flex items-center gap-1">
                                ...
                                <span className="text-[9px] font-bold text-red-300 uppercase tracking-widest">Terkunci</span>
                              </div>
                            </div>
                          </div>
                        </div>
                        <button
                          ...
                          className="px-6 py-2.5 bg-gray-50 text-gray-400 group-hover:bg-blue-600 group-hover:text-white group-hover:shadow-lg group-hover:shadow-blue-600/20 rounded-xl text-[10px] font-bold uppercase tracking-widest transition-all active:scale-95 flex items-center gap-2"
                        >
                          Buka
                          <ArrowRight size={14} />
                        </button>
              ...
              <div className="p-8 border-t border-gray-100 bg-white flex flex-col md:flex-row items-center justify-between gap-6">
                <div className="text-center md:text-left">
                  <p className="text-gray-900 font-bold uppercase tracking-tight">Siap untuk Inisialisasi?</p>
                ...
                <div className="flex gap-4 w-full md:w-auto">
                  <Link
                    to="/signup"
                    className="flex-1 md:flex-none px-8 py-4 bg-blue-600 text-white font-bold uppercase tracking-[0.2em] text-[10px] rounded-2xl shadow-xl shadow-blue-600/20 hover:bg-blue-700 transition-all text-center"
                  >
                    Daftar Sekarang
                  </Link>
                  <Link
                    to="/login"
                    className="flex-1 md:flex-none px-8 py-4 bg-gray-50 text-gray-900 font-bold uppercase tracking-[0.2em] text-[10px] rounded-2xl hover:bg-gray-100 transition-all text-center"
                  >
                    Masuk
                  </Link>
                </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              ...
              >
                ...
                <div className="text-4xl font-bold text-gray-900 mb-2 tracking-tighter ">{stat.value}</div>
      ...
      <section className="py-24 md:py-32 bg-gray-50/50">
        <div className="max-w-6xl mx-auto px-6 md:px-8">
          <div className="text-center mb-24">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 tracking-tighter uppercase mb-6">
              Keunggulan Operatif
            </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              ...
              >
                ...
                <h3 className="text-lg font-bold text-gray-900 mb-4 uppercase tracking-tight">{feature.title}</h3>
      ...
      <section className="py-32 bg-white relative overflow-hidden">
        <div className="max-w-4xl mx-auto px-8 py-20 bg-gradient-to-br from-indigo-900 to-indigo-950 rounded-[60px] text-center relative overflow-hidden shadow-2xl shadow-indigo-900/40">
          ...
          <div className="relative z-10">
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-8 tracking-tighter uppercase">
            ...
            <Link
              to="/signup"
              className="inline-flex items-center gap-4 px-12 py-6 bg-white text-indigo-900 rounded-[24px] font-bold uppercase tracking-[0.2em] text-xs hover:bg-blue-50 transition-all shadow-2xl active:scale-95"
            >
          ...
          <div className="flex flex-col items-center text-center">
            <div className="mb-8">
              <a
                ...
                className="text-[9px] font-bold uppercase tracking-[0.3em] text-gray-400 hover:text-indigo-600 transition-colors bg-gray-50 px-6 py-2 rounded-full"
              >
            ...
            <div className="flex items-center gap-4 mb-10">
              <img
                ...
                className="w-10 h-10 object-contain"
              />
              <span className="text-2xl font-bold text-gray-900 tracking-tighter uppercase">Kaze Developer</span>
            </div>

            <div className="flex gap-10 mb-10 text-[10px] font-bold uppercase tracking-[0.2em] text-gray-400">
