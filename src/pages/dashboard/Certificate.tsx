          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-6 bg-black/60 backdrop-blur-md print:hidden">
            ...
            >
              <div className="p-8">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-2 leading-tight uppercase tracking-tighter">Personalisasi Sertifikat</h3>
                ...
                <div className="space-y-6">
                  ...
                  <button
                    ...
                    className="w-full py-5 bg-indigo-600 hover:bg-indigo-700 disabled:opacity-50 text-white font-bold rounded-2xl shadow-xl shadow-indigo-600/20 transition-all active:scale-95 uppercase tracking-widest text-xs"
                  >
      ...
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 mb-12 print:hidden">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900 leading-tight">Sertifikat Kelulusan</h1>
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={handlePrint}
              className="flex items-center gap-2 px-8 py-3 bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-2xl transition-all active:scale-95 shadow-xl shadow-indigo-600/20"
            >
          ...
          <div className="p-12 md:p-20 relative z-10">
            ...
            <div className="flex justify-between items-start mb-16">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-xl font-bold tracking-tighter text-gray-900">KAZE FOR DEVELOPER</p>
                  <p className="text-[10px] font-bold text-gray-400 uppercase tracking-[0.3em]">Academy of Excellence</p>
                </div>
              </div>
            ...
            <div className="text-center space-y-8">
              <div className="space-y-4">
                <h2 className="text-sm font-bold text-indigo-600 uppercase tracking-[0.5em] mb-4">Sertifikat Kelulusan</h2>
                <p className="text-gray-500 font-medium ">Sertifikat ini secara resmi diberikan kepada:</p>
                <h3 className="text-5xl md:text-7xl font-bold text-gray-900 tracking-tight py-4 border-y border-gray-50">
                  {studentName || '................'}
                </h3>
              </div>
              ...
              <div className="max-w-2xl mx-auto py-8">
                ...
                <p className="text-3xl font-bold text-indigo-900 mt-6 bg-indigo-50 inline-block px-10 py-3 rounded-full border border-indigo-100">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-12 pt-16">
                <div className="text-left">
                  <p className="text-[10px] font-bold text-gray-400 uppercase tracking-[0.2em] mb-1">Diberikan pada</p>
                ...
                <div className="flex flex-col items-center">
                  ...
                  <p className="text-[10px] font-bold text-indigo-600 uppercase tracking-[0.2em]">Verified Secure</p>
                </div>
                <div className="text-right">
                  <p className="text-[10px] font-bold text-gray-400 uppercase tracking-[0.2em] mb-1">ID Sertifikat</p>
                  <code className="text-[11px] font-bold text-gray-900 bg-gray-50 px-3 py-1 rounded border border-gray-100">{certificateCode}</code>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mt-8 p-6 bg-white rounded-3xl border border-gray-200 shadow-sm flex items-center gap-4 print:hidden">
          ...
          <div>
            <p className="font-bold text-gray-900 text-sm ">PRO-TIP: CARA DOWNLOAD PDF</p>
