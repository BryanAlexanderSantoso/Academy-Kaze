    ...
    return (
      <div className="max-w-3xl mx-auto py-20 px-10">
        ...
        >
          ...
          <h2 className="text-4xl font-bold text-gray-900 mb-4 uppercase tracking-tighter leading-none relative z-10">
            {isPremiumPlus ? 'PREMIUM+ AKTIF!' : 'PREMIUM AKTIF!'}
          </h2>

          <div className="flex flex-col items-center gap-6 relative z-10">
            <p className={`text-[10px] font-bold uppercase tracking-[0.2em] px-6 py-2 rounded-xl border ${isPremiumPlus ? 'bg-amber-50 text-amber-600 border-amber-100' : 'bg-indigo-50 text-indigo-600 border-indigo-100'}`}>
              {isPremiumPlus ? '🌟 AKSES_TANPA_BATAS_TERVERSION' : '📚 AKSES_SECTOR_JALUR_BELAJAR'}
            </p>

            <div className={`inline-flex items-center gap-3 px-6 py-3 rounded-2xl font-bold tracking-tight text-lg shadow-inner border ${user.premium_until ? 'bg-green-50 text-green-700 border-green-100' : 'bg-amber-50 text-amber-700 border-amber-100'}`}>
          ...
          <p className="text-gray-400 font-medium mt-10 mb-12 max-w-md mx-auto relative z-10 leading-relaxed">
            {isPremiumPlus
          ...
          <div className="space-y-4 relative z-10">
            {!isPremiumPlus && (
              ...
              >
                ...
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <span className="font-bold text-amber-900 text-sm uppercase tracking-widest">Upgrade ke Premium+?</span>
                </div>
                <p className="text-xs text-amber-700 mb-6 font-medium ">Butuh fleksibilitas lebih? Buka kunci semua materi dari sector Frontend, Backend, hingga Fullstack sekaligus!</p>
                <button
                  onClick={() => setSelectedTier('premium_plus')}
                  className="w-full bg-gradient-to-r from-amber-500 to-orange-600 text-white text-[10px] font-bold py-4 rounded-2xl shadow-xl shadow-amber-500/30 hover:shadow-amber-500/50 transition-all uppercase tracking-[0.2em] "
                >
                  EKSES_SEMUA_SECTOR
                </button>
              </motion.div>
            ...
            <button
              ...
              className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-6 rounded-[30px] flex items-center justify-center gap-3 transition-all transform hover:-translate-y-1 active:scale-95 shadow-2xl shadow-indigo-600/30 uppercase tracking-[0.3em] text-[10px]"
            >
            ...
            <button
              ...
              className="text-[10px] text-red-400 font-bold hover:text-red-600 uppercase tracking-widest transition-colors mt-6 block mx-auto underline-offset-8 hover:underline"
            >
          ...
          {showCancelConfirm && (
            <div className="fixed inset-0 z-[100] flex items-center justify-center p-10">
              ...
              >
                ...
                <h3 className="text-3xl font-bold text-gray-900 mb-2 uppercase tracking-tighter">TERMINASI_AKSES?</h3>
                <p className="text-gray-400 font-medium mb-10">Seluruh otorisasi materi akan dikunci kembali secara permanen.</p>

                <div className="flex flex-col md:flex-row gap-4">
                  <button
                    onClick={() => setShowCancelConfirm(false)}
                    disabled={cancelling}
                    className="flex-1 py-6 bg-gray-100 text-gray-400 font-bold text-[10px] rounded-[25px] hover:bg-gray-200 hover:text-gray-900 transition-all uppercase tracking-[0.3em] "
                  >
                    BATALKAN_PROSES
                  </button>
                  <button
                    ...
                    disabled={cancelling}
                    className="flex-1 py-6 bg-red-600 text-white font-bold text-[10px] rounded-[25px] hover:bg-red-700 transition-all uppercase tracking-[0.3em] shadow-xl shadow-red-500/20"
                  >
    ...
    <div className="max-w-6xl mx-auto space-y-16 pb-40 px-10">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-10">
        <div className="flex items-center gap-8">
          ...
          <div>
            <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-indigo-50 rounded-full text-indigo-600 text-[10px] font-bold uppercase tracking-widest border border-indigo-100 mb-3">
              <Activity className="w-3.5 h-3.5" />
              Upgrade Protokol
            </div>
            <h1 className="text-5xl lg:text-7xl font-bold text-gray-900 tracking-tighter uppercase leading-[0.9]">
              Upgrade <br />
              <span className="text-indigo-600">Akses Premium</span>
            </h1>
          </div>
        </div>
        <p className="max-w-xs text-gray-400 text-sm font-medium text-right hidden md:block">Pilih paket otorisasi yang sesuai dengan kurikulum belajar Anda saat ini.</p>
      </div>
          ...
          <div>
            <div className="flex items-center justify-between mb-10">
              ...
              {selectedTier === 'premium' && (
                <span className="px-5 py-2 bg-indigo-600 text-white text-[9px] font-bold uppercase tracking-widest rounded-full shadow-lg ">
                  TERPILIH
                </span>
              )}
            </div>
            ...
            <div className="space-y-2 mb-10">
              <h3 className="text-3xl font-bold text-gray-900 uppercase tracking-tighter">Premium</h3>
              <p className="text-[10px] font-bold text-indigo-600 uppercase tracking-widest ">AKSES_JALUR_BELAJAR</p>
            </div>

            <div className="mb-12">
              <div className="flex items-baseline gap-2">
                <span className="text-5xl font-bold text-gray-900 tracking-tighter">Rp{PRICES.premium.toLocaleString()}</span>
                <span className="text-sm font-bold text-gray-300 uppercase ">/lifetime</span>
              </div>
            </div>
            ...
            <div className="space-y-6">
              {[
                ...
                <div key={i} className="flex items-start gap-4">
                  ...
                  <span className="text-sm font-medium text-gray-500">{f.text}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div>
            <div className="flex items-center justify-between mb-10 relative z-10">
              ...
              <div className="flex gap-2">
                <span className="px-5 py-2 bg-gradient-to-r from-amber-500 to-orange-500 text-white text-[9px] font-bold uppercase tracking-widest rounded-full shadow-lg flex items-center gap-2 ">
            ...
            <div className="space-y-2 mb-10 relative z-10">
              <h3 className="text-3xl font-bold text-gray-900 uppercase tracking-tighter">Premium+</h3>
              <p className="text-[10px] font-bold text-amber-600 uppercase tracking-widest ">AKSES_SELURUH_MATERI</p>
            </div>

            <div className="mb-12 relative z-10">
              <div className="flex items-baseline gap-2">
                <span className="text-5xl font-bold text-gray-900 tracking-tighter">Rp{PRICES.premium_plus.toLocaleString()}</span>
                <span className="text-sm font-bold text-gray-300 uppercase ">/lifetime</span>
              </div>
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
        ...
        <div className="space-y-10">
          ...
          >
            <div className="flex items-center gap-3 text-indigo-600 font-bold text-[10px] uppercase tracking-[0.2em] ">
            ...
            {appliedPromo ? (
              <div className="bg-emerald-50 p-8 rounded-[35px] border border-emerald-100 relative overflow-hidden group/promo">
                ...
                <div className="flex items-center justify-between mb-4">
                  <div>
                    <p className="text-[10px] font-bold text-emerald-800 uppercase tracking-widest mb-1">Kode Aktif:</p>
                    <h4 className="text-3xl font-bold text-emerald-900 tracking-tighter leading-none">{appliedPromo.code}</h4>
                  </div>
                ...
                <p className="text-sm font-medium text-emerald-700 ">Diskon instan {appliedPromo.discount_percent}% telah didekripsi sistem.</p>
              </div>
            ) : (
              <div className="flex flex-col sm:flex-row gap-4">
                <input
                  ...
                  className="flex-1 bg-gray-50 border-none rounded-[25px] px-8 py-5 text-[11px] font-bold uppercase tracking-widest placeholder:text-gray-200 focus:ring-[15px] focus:ring-indigo-600/5 transition-all shadow-inner"
                />
                <button
                  onClick={handleApplyPromo}
                  disabled={promoLoading || !promoCode.trim()}
                  className="px-10 py-5 bg-gray-900 text-white font-bold text-[10px] rounded-[25px] hover:bg-black disabled:opacity-30 disabled:cursor-not-allowed transition-all uppercase tracking-[0.3em] shadow-xl shadow-gray-900/10"
                >
                  {promoLoading ? 'VERIFYING...' : 'GUNAKAN_PROMO'}
                </button>
              </div>
            )}
            {promoError && (
            ...
            <div className="relative z-10 flex flex-col justify-between h-full">
              <div className="space-y-6">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="text-2xl font-bold text-white tracking-tighter leading-none">
                    TOTAL_INVESTASI_{selectedTier.toUpperCase()}
                  </h3>
                </div>
                ...
                <div className="space-y-4">
                  {appliedPromo && (
                    <div className="flex items-center gap-4">
                      <span className="text-2xl font-bold text-white/40 line-through tracking-tighter leading-none">Rp{getBasePrice().toLocaleString()}</span>
                      <span className="px-3 py-1 bg-white/20 rounded-xl text-[9px] font-bold text-white uppercase tracking-widest">-{appliedPromo.discount_percent}% OFF</span>
                    </div>
                  )}
                  <div className="text-6xl font-bold text-white tracking-tighter leading-none">Rp{getFinalPrice().toLocaleString()}</div>
                  <p className="text-[10px] font-bold text-white/60 uppercase tracking-widest leading-relaxed">
                    INVESTASI SEKALI UNTUK AKSES SEUMUR HIDUP DI KAZE FOR DEVELOPER.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-amber-50 rounded-[50px] border border-amber-100 p-10 space-y-8">
            <div className="flex items-center gap-4 text-amber-700 font-bold text-[10px] uppercase tracking-[0.2em] ">
              ...
              <div className="grid grid-cols-1 gap-6">
                {[
                  ...
                  <div key={i} className="flex gap-6 items-start">
                    <span className="text-xl font-bold text-amber-300 tracking-tighter">{s.step}</span>
                    <p className="text-sm font-medium text-amber-800 leading-relaxed">{s.text}</p>
                  </div>
                ))}
              </div>
          ...
          >
            {submitted ? (
              <div className="py-20 text-center space-y-10">
                ...
                <div className="space-y-4">
                  <h3 className="text-3xl font-bold text-gray-900 uppercase tracking-tighter leading-none">Data Terkirim</h3>
                  <p className="text-sm font-medium text-gray-400 max-w-xs mx-auto">Admin akan melakukan verifikasi pembayaran Anda dalam kurun waktu 1x24 jam.</p>
                </div>
                <button onClick={() => setSubmitted(false)} className="text-[10px] font-bold text-indigo-600 uppercase tracking-widest hover:underline">
                  KIRIM_ULANG_BUKTI?
                </button>
              </div>
            ) : (
              <div className="space-y-10">
                <div className="space-y-2">
                  <h3 className="text-3xl font-bold text-gray-900 uppercase tracking-tighter leading-none">Konfirmasi <br /><span className="text-indigo-600">Pembayaran</span></h3>
                  <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest ">UNGGAH_BUKTI_PEMBAYARAN</p>
                </div>

                <div className="space-y-8">
                  <div className="space-y-4">
                    <label className="text-[10px] font-bold text-gray-400 uppercase tracking-[0.2em] ">PILIH_FILE_SCREENSHOT</label>
                    <input
                      type="file"
                      ref={fileInputRef}
                    ...
                    {!selectedFile ? (
                      ...
                      >
                        ...
                        <div className="text-center space-y-2">
                          <p className="text-[10px] font-bold text-gray-300 uppercase tracking-[0.3em] ">KLIK UNTUK UNGGAH</p>
                  ...
                  <div className="p-8 bg-gray-50 rounded-[40px] border border-gray-100 space-y-4 shadow-inner">
                    ...
                    {appliedPromo && (
                      <div className="flex justify-between items-center text-[10px] font-bold text-emerald-600 uppercase tracking-widest animate-in fade-in slide-in-from-left duration-500">
                        <span>PROMO_{appliedPromo.code}</span>
                        <span>-{appliedPromo.discount_percent}%</span>
                      </div>
                    )}
                    <div className="border-t border-gray-200 pt-4 flex justify-between items-end">
                      <span className="text-[10px] font-bold text-gray-900 uppercase tracking-widest ">TOTAL_PEMBAYARAN</span>
                      <span className="text-3xl font-bold text-indigo-600 tracking-tighter">Rp{getFinalPrice().toLocaleString()}</span>
                    </div>
                  </div>
                  ...
                  <button
                    ...
                    className={`w-full py-8 text-[11px] font-bold uppercase tracking-[0.4em] rounded-[30px] transition-all transform hover:-translate-y-2 active:scale-95 shadow-2xl flex items-center justify-center gap-4 ${selectedTier === 'premium_plus'
          ...
          <div className="bg-indigo-600 p-12 rounded-[60px] relative overflow-hidden group/chat">
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center gap-10">
              ...
              <div className="flex-1 text-center md:text-left">
                <h4 className="text-2xl font-bold text-white tracking-tighter mb-2 ">PUSAT_BANTUAN</h4>
                <p className="text-sm font-medium text-indigo-100 mb-6">Butuh asistensi manual untuk aktivasi protokol atau kendala gateway pembayaran?</p>
                <div className="inline-flex items-center gap-3 px-6 py-3 bg-white/10 backdrop-blur-md rounded-2xl border border-white/10 text-[10px] font-bold text-white uppercase tracking-widest ">
      ...
      >
        <div className="space-y-16">
          <div className="text-center space-y-4">
            <h3 className="text-4xl font-bold text-gray-900 uppercase tracking-tighter">Matriks <br /><span className="text-indigo-600">Fitur</span></h3>
            <p className="text-gray-400 font-medium max-w-lg mx-auto">Tabel perbandingan level akses untuk efisiensi pemilihan paket upgrade.</p>
          </div>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b-2 border-gray-50">
                  <th className="text-left pb-10 px-6 text-[10px] font-bold text-gray-300 uppercase tracking-widest ">VARIABEL_FITUR</th>
                  <th className="text-center pb-10 px-6 text-[11px] font-bold text-indigo-600 uppercase tracking-[0.2em] ">PREMIUM</th>
                  <th className="text-center pb-10 px-6 text-[11px] font-bold text-amber-500 uppercase tracking-[0.2em] ">PREMIUM+</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-50">
                {[
                  ...
                  <tr key={i} className="group hover:bg-gray-50/50 transition-colors">
                    <td className="py-8 px-6 text-[13px] font-bold text-gray-600 uppercase tracking-tighter">{row.feature}</td>
                    <td className="py-8 px-6 text-center">
                      {row.premium === true ? (
                        ...
                        <span className="text-[9px] font-bold text-gray-300 uppercase tracking-widest bg-gray-50 px-3 py-1.5 rounded-lg">SESUAI JALUR</span>
                      ) : (
