    ...
    <div className="min-h-screen bg-white flex items-center justify-center p-6 relative overflow-hidden font-sans selection:bg-indigo-100">
      ...
      >
        <div className="mb-12">
          <Link
            to="/login"
            className="inline-flex items-center gap-2 text-[10px] font-bold text-gray-400 uppercase tracking-widest hover:text-indigo-600 transition-colors mb-8"
          >
          ...
          <h3 className="text-4xl font-bold text-gray-900 mb-2 tracking-tighter uppercase ">Reset Password</h3>
        ...
        {!success ? (
          ...
          >
            ...
            <div className="space-y-2">
              <h4 className="text-2xl font-bold text-gray-900 tracking-tighter uppercase ">Email Sent</h4>
            ...
            <Link
              to="/login"
              className="inline-flex items-center justify-center gap-3 w-full border-2 border-gray-100 hover:border-gray-900 hover:bg-gray-900 hover:text-white transition-all py-6 rounded-[30px] text-[10px] font-bold uppercase tracking-[0.3em]"
            >
              Return to Login
            </Link>
          </motion.div>
