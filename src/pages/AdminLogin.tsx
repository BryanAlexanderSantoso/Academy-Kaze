      ...
      >
        ...
        <div className="bg-white/[0.03] backdrop-blur-2xl rounded-[40px] border border-white/10 shadow-3xl overflow-hidden p-10 relative">
          ...
          <div className="text-center mb-10">
            ...
            <h1 className="text-2xl font-bold text-white tracking-widest uppercase mb-2">Clearance Entry</h1>
            <div className="flex items-center justify-center gap-2">
              <Activity className="w-3 h-3 text-emerald-500 animate-pulse" />
              <p className="text-[10px] font-bold text-gray-500 uppercase tracking-[0.3em]">System Identity Required</p>
            </div>
          </div>

          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="group">
              <label className="block text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-3 ml-1 group-focus-within:text-indigo-400 transition-colors">Access Cipher</label>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-bold uppercase tracking-[0.3em] py-5 rounded-2xl shadow-xl shadow-indigo-600/20 transition-all active:scale-95 disabled:opacity-50 group flex items-center justify-center gap-3"
            >
          ...
          <div className="mt-10 pt-10 border-t border-white/[0.05] text-center">
            <button
              ...
              className="text-[10px] font-bold text-gray-600 hover:text-white uppercase tracking-[0.2em] transition-all flex items-center justify-center gap-2 mx-auto"
            >
        ...
        <div className="mt-8 text-center">
          <p className="text-[8px] font-bold text-gray-800 uppercase tracking-[0.5em] leading-relaxed">
