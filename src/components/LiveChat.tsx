        ...
        {isOpen && (
          ...
          >
            ...
            <div className="bg-gray-900 px-8 py-7 relative overflow-hidden">
              ...
              <div className="relative z-10 flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="text-sm font-bold text-white uppercase tracking-tighter ">Support_Nexus</h3>
                    <div className="flex items-center gap-2 mt-1">
                      <span className="w-2 h-2 bg-emerald-500 rounded-full animate-pulse shadow-[0_0_8px_rgba(16,185,129,0.5)]"></span>
                      <p className="text-[9px] font-bold text-emerald-400 uppercase tracking-widest ">Online • Respons: ~15 Mnit</p>
                    </div>
                  </div>
                </div>
                <div className="px-3 py-1 bg-white/5 rounded-lg border border-white/10">
                  <p className="text-[8px] font-bold text-gray-400 uppercase tracking-widest">ID: {user?.id.slice(0, 8)}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-amber-500/5 px-6 py-3 flex items-center gap-3 border-b border-amber-500/10">
              ...
              <p className="text-[9px] font-bold text-amber-600/80 uppercase tracking-widest leading-none">
            ...
            <div className="flex-1 overflow-y-auto p-8 space-y-6 bg-[#FAFAFF] custom-scrollbar">
              {loading ? (
                <div className="flex flex-col items-center justify-center h-full gap-4">
                  ...
                  <p className="text-[10px] font-bold text-gray-300 uppercase tracking-widest animate-pulse">Sinkronisasi_Data...</p>
                </div>
              ) : messages.length === 0 ? (
                <div className="flex flex-col items-center justify-center h-full text-center px-10">
                  ...
                  <h4 className="text-lg font-bold text-gray-900 uppercase tracking-tighter mb-2">Butuh Bantuan Teknis?</h4>
            ...
            <div className="p-8 bg-white border-t border-gray-100">
              <div className="flex items-end gap-3 p-2 bg-gray-50 rounded-[30px] border border-gray-100 focus-within:border-indigo-600/30 focus-within:bg-white transition-all shadow-inner">
                <textarea
                  ...
                  rows={1}
                  className="flex-1 resize-none bg-transparent border-none px-4 py-3 text-sm font-medium focus:ring-0 placeholder:text-gray-300 placeholder: placeholder:font-bold placeholder:text-[10px] placeholder:uppercase placeholder:tracking-widest"
                />
                <motion.button
              ...
              <div className="mt-4 flex items-center justify-between px-2">
                <div className="flex items-center gap-2 text-indigo-400 ">
                  <Sparkles size={10} />
                  <span className="text-[8px] font-bold uppercase tracking-widest">Premium_Encrypted_Link</span>
                </div>
                <p className="text-[8px] font-bold text-gray-300 uppercase tracking-widest ">Shift+Enter untuk baris baru</p>
              </div>
            </div>
          </motion.div>
        )}
