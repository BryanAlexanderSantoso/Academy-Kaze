      ...
      >
        ...
        {unreadCount > 0 && (
          <span className="absolute -top-1 -right-1 flex h-5 w-5">
            ...
            <span className="relative inline-flex rounded-full h-5 w-5 bg-red-500 text-[10px] font-bold text-white items-center justify-center border-2 border-white shadow-lg ">
              {unreadCount}
            </span>
          </span>
        )}
            ...
            <div className="relative">
              <div className="flex items-start justify-between gap-5 mb-5 border-b border-gray-50 pb-5">
                ...
                <div className="flex-1 min-w-0">
                  <h4 className="text-[10px] font-bold text-gray-400 uppercase tracking-[0.2em] leading-none mb-1.5 ">NOTIFIKASI BARU</h4>
                  <h3 className="text-sm font-bold text-gray-900 uppercase tracking-tighter truncate ">{activePopup.title}</h3>
                </div>
                <button
              ...
              <p className="text-[13px] font-medium text-gray-600 mb-6 line-clamp-2 leading-relaxed ">
                {activePopup.message}
              </p>

              <button
                onClick={() => handleNotificationClick(activePopup)}
                className="w-full py-4 bg-gray-900 hover:bg-black text-white text-[10px] font-bold uppercase tracking-[0.3em] rounded-2xl flex items-center justify-center gap-3 transition-all active:scale-95 shadow-2xl shadow-gray-900/10 "
              >
            ...
            >
              <div className="p-8 border-b border-gray-50 flex items-center justify-between bg-gray-50/50">
                <div className="space-y-1">
                  <span className="font-bold text-[10px] uppercase tracking-[0.3em] text-gray-900 ">RIWAYAT</span>
                  <p className="text-[8px] font-bold text-gray-400 uppercase tracking-widest leading-none">Update Terbaru</p>
                </div>
                {unreadCount > 0 && (
                  <button
                    onClick={markAllAsRead}
                    className="px-4 py-2 bg-indigo-50 text-[9px] font-bold uppercase text-indigo-600 hover:bg-indigo-600 hover:text-white rounded-xl transition-all tracking-wider flex items-center gap-2 "
                  >
              ...
              <div className="max-h-[450px] overflow-y-auto custom-scrollbar bg-white">
                {notifications.length > 0 ? (
                      ...
                      >
                        <div className="flex-1 min-w-0 space-y-3">
                          <div className="flex items-start justify-between gap-4">
                            <div className="space-y-1">
                              <h4
                                ...
                                className="text-sm font-bold text-gray-900 uppercase tracking-tighter cursor-pointer hover:text-indigo-600 transition-colors truncate "
                              >
                                {notification.title}
                              </h4>
                              <span className="text-[9px] font-bold text-gray-400 uppercase tracking-widest block opacity-60">
                          ...
                          {notification.link && (
                            <button
                              onClick={() => handleNotificationClick(notification)}
                              className="flex items-center gap-2 text-[9px] font-bold uppercase text-indigo-600 hover:underline tracking-widest "
                            >
                  ...
                  <div className="py-24 text-center px-12">
                    ...
                    <h4 className="font-bold text-[11px] uppercase text-gray-400 tracking-[0.4em] mb-3">BELUM ADA NOTIFIKASI</h4>
                    <p className="text-[10px] font-bold text-gray-200 uppercase tracking-[0.2em] leading-relaxed">Notifikasi terbaru akan muncul di sini.</p>
                  </div>
                )}
              </div>
              ...
              <div className="p-6 bg-gray-50/50 border-t border-gray-100/50 text-center">
                <button
                  onClick={() => setShowDropdown(false)}
                  className="text-[10px] font-bold uppercase tracking-[0.4em] text-gray-400 hover:text-red-500 transition-all py-3 active:scale-95 "
                >
                  TUTUP
                </button>
              </div>
