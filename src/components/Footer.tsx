        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="mb-6">
              ...
              >
                <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-gray-400 group-hover:text-indigo-400 transition-colors">Under the auspices of</span>
                <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-white">Kaze Serenity</span>
              </a>
            </div>
